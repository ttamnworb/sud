...
namespace SUD
{
	...
	public:
		...
		/// Class constructor
		/// </summary>
		PlayerObject(Game* pGame = nullptr);
		...
		/// Check that there is an exit in that direction and that the player can use it.
		/// </summary>
		/// <param name="direction">Any direction</param>
		/// <returns>true if the player moved to a new location, false otherwise.</returns>
		...
		/// </summary>
		/// <returns></returns>
		std::string GetLocationName() const { return m_CurrentLocationName; }
